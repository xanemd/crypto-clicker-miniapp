            ...
            <div class="page-about" style="display: none;">
                <div class="card card-style shadow-xl">
                    <div class="content">
						...
						<p class="mb-1">Автор проекта: <a href="https://t.me/bmjcoin_official" target="_blank">BMJCoin</a>. С момента своего зарождения проект быстро привлек внимание сообщества и стал активно развиваться.</p>
						...
						<p class="mb-1">Следите за обновлениями и новостями проекта в Telegram-канале: <a href="https://t.me/bmjcoin_official" target="_blank">BMJCoin</a>. Узнавайте первыми о новых функциях, акциях и событиях, а также делитесь своими успехами и впечатлениями с другими участниками сообщества.</p>
                    </div>
                </div>
            </div>
